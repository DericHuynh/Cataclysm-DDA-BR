...
## Purpose
- `cdda-cli` binary (Layer 5 app shell) — schema generation, JSON validation, definition statistics, full load check, ablation testing, a 15×15 ASCII city preview, and the Phase-A **round-trip** data-consistency check, for CDDA mod developers. Single source file: `src/main.rs`.
