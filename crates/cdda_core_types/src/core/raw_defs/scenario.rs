...
pub struct ScenarioDef {
    ...
    pub start_location: Option<DefId<crate::core::raw_defs::start_location::StartLocationDef>>,
    ...
    #[serde(default)]
    pub forced_traits: Vec<DefId<crate::core::raw_defs::mutation::MutationDef>>,

    /// Traits that are forbidden.
    #[serde(default)]
    pub forbidden_traits: Vec<DefId<crate::core::raw_defs::mutation::MutationDef>>,

    /// Allowed traits.
    #[serde(default)]
    pub allowed_traits: Vec<DefId<crate::core::raw_defs::mutation::MutationDef>>,

    /// Additional items to start with.
    #[serde(default)]
    pub starting_items: Option<crate::core::raw_defs::cdda_types::StartingItems>,
