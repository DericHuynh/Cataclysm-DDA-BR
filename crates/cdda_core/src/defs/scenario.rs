...
pub struct ScenarioDef {
    ...
    pub start_location: Option<DefId<crate::defs::start_location::StartLocationDef>>,
    ...
    #[serde(default)]
    pub forced_traits: Vec<DefId<crate::defs::mutation::MutationDef>>,

    /// Traits that are forbidden.
    #[serde(default)]
    pub forbidden_traits: Vec<DefId<crate::defs::mutation::MutationDef>>,

    /// Allowed traits.
    #[serde(default)]
    pub allowed_traits: Vec<DefId<crate::defs::mutation::MutationDef>>,

    /// Additional items to start with.
    #[serde(default)]
    pub starting_items: Option<serde_json::Value>,

    /// Starting vehicle.
    #[serde(default)]
    pub vehicle: Option<String>,

    /// Missions automatically started.
    #[serde(default)]
    pub missions: Option<Vec<ScenarioMission>>,
...
/// A mission that starts with this scenario.
#[derive(Debug, Clone, Serialize, Deserialize)]
