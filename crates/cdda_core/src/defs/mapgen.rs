...
pub struct MapgenDef {
    ...
    #[serde(default)]
    pub fill_ter: Option<DefId<crate::defs::terrain::TerrainDef>>,
    ...
    #[serde(default)]
    pub furniture: Option<Value>,

    /// Place result (field or type-specific data).
    #[serde(default)]
    pub place_result: Option<Value>,
    ...
    /// TODO: permissive catch-all for other fields
    #[serde(default)]
...
pub struct PlaceTerrain {
    ...
    /// Target terrain.
    pub terrain: DefId<crate::defs::terrain::TerrainDef>,
...
pub struct PlaceFurniture {
    ...
    #[serde(default)]
    pub y: Option<i32>,
    pub furn: DefId<crate::defs::furniture::FurnitureDef>,
    #[serde(default)]
    pub repeat: Option<u32>,
}
...
pub struct PlaceItems {
    ...
    pub item: DefId<crate::defs::item_group::ItemGroupDef>,
