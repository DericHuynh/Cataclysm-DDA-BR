...
pub struct VehiclePartDef {
    ...
    #[serde(default)]
    pub color_broken: Option<String>,
    ...
    pub location: DefId<VehiclePartLocationDef>,
    ...
    #[serde(default)]
    pub power: Option<crate::units::Energy>,

    /// Energy consumption rate.
    #[serde(default)]
    pub energy_consumption: Option<crate::units::Energy>,

    /// Description of what this part does (fuel consumption, power generation, etc).
    #[serde(default)]
    pub description_extra: Option<String>,

    /// Whether part breaks first.
    #[serde(default)]
    pub breaks_into: Option<Vec<VehiclePartBreak>>,
    ...
    /// Broken color
    #[serde(default)]
    pub broken_color: Option<String>,
...
/// Requirements for installing a vehicle part.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct VehiclePartRequirements {
    #[serde(default)]
    pub skills: Vec<VehiclePartSkillReq>,
    #[serde(default)]
    pub time: Option<u32>,
    #[serde(default)]
...
pub struct VehiclePartCategoryDef {
    ...
    /// Short name for UI.
    #[serde(default)]
    pub short_name: Option<crate::types::LocalizedString>,
