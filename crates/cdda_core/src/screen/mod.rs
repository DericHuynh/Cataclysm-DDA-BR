//! # cdda_screen — Headless screen state machine
//!
...
//!
//! `cdda_render` reads the same `Screen` state and registers
...
impl Plugin for ScreenNavigationPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.insert_resource(crate::screen::config::WorldCreationSettings::default());
        ...
        app.add_systems(Update, crate::screen::screen_nav::sync_input_context);
