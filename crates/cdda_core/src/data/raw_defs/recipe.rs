...
pub struct RecipeDef {
    ...
    #[serde(default)]
    pub result: Option<DefId<crate::data::raw_defs::item::ItemDef>>,
    ...
    /// Primary skill used.
    #[serde(default)]
    pub skill_used: Option<DefId<crate::data::raw_defs::skill::SkillDef>>,
    ...
    #[serde(default)]
    pub container: Option<DefId<crate::data::raw_defs::item::ItemDef>>,
    ...
    /// Batch time factors.
    #[serde(default)]
    pub batch_time_factors: Option<crate::data::raw_defs::cdda_types::BatchTimeFactors>,

    /// Proficiencies required.
    #[serde(default)]
    pub proficiencies: Option<Vec<crate::data::raw_defs::cdda_types::ProficiencyReq>>,
...
pub enum SkillsRequired {
    ...
    SingleFlat(DefId<crate::data::raw_defs::skill::SkillDef>, u32),
...
pub enum SkillRequirement {
    ...
    Object {
        id: DefId<crate::data::raw_defs::skill::SkillDef>,
        level: u32,
    },
    /// Tuple form: `["fabrication", 3]`
    Tuple(DefId<crate::data::raw_defs::skill::SkillDef>, u32),
}
