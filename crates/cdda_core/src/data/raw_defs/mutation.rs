use crate::data::raw_defs::cdda_types::{RawValue, StringOrArray};
...
pub struct MutationDef {
    ...
    #[serde(default)]
    pub enchantments: Option<Vec<crate::data::raw_defs::cdda_types::RawValue>>,
...
pub struct MutationCategoryDef {
    ...
    /// Mutagen item type.
    #[serde(default)]
    pub mutagen: Option<DefId<crate::data::raw_defs::item::ItemDef>>,
