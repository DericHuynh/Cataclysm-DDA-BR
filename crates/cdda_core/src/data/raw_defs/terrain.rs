use crate::data::raw_defs::cdda_types::{CddaColor, CountRange, ExamineAction, RawValue, StringOrArray};
...
pub struct TerrainBash {
    ...
    #[serde(default)]
    pub furn_set: Option<DefId<crate::data::raw_defs::furniture::FurnitureDef>>,
...
pub struct BashItemDrop {
    /// Item type to drop.
    #[serde(default)]
    pub item: Option<DefId<crate::data::raw_defs::item::ItemDef>>,
