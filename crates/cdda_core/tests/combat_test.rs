...
fn melee_to_hit(stats: &cdda_core::core::components::actor::CombatStats) -> f32 {
...
fn combat_stats_initialized() {
    ...
    test.register::<cdda_core::core::components::actor::CombatStats>();

    let e = test.spawn((cdda_core::core::components::actor::CombatStats {
        melee_skill: 5,
        melee_dice: 2,
        melee_dice_sides: 6,
        dodge: 2,
        armor: cdda_core::core::components::actor::DamageReduction {
            bash: 0,
            cut: 0,
            pierce: 0,
            bullet: 0,
    ...
    let stats = test.get::<cdda_core::core::components::actor::CombatStats>(e).unwrap();
...
fn damage_reduction_bash() {
    let armor = cdda_core::core::components::actor::DamageReduction {
        bash: 5,
        cut: 0,
        pierce: 0,
        bullet: 0,
...
fn vision_range() {
    let mut test = TestBed::new();
    test.register::<cdda_core::core::components::actor::Vision>();

    let e = test.spawn((cdda_core::core::components::actor::Vision {
        day_range: 40,
        night_range: 5,
    },));
    let vision = test.get::<cdda_core::core::components::actor::Vision>(e).unwrap();
...
fn creature_identity() {
    ...
    let e = test.spawn((cdda_core::core::components::actor::Creature {
        def_id: "mon_zombie".to_string(),
        name: "zombie".to_string(),
        species: cdda_core::SpeciesId::from(0u32),
        symbol: 'Z',
    },));
    let creature = test.get::<cdda_core::core::components::actor::Creature>(e).unwrap();
...
fn melee_to_hit_calculation() {
    ...
    let stats = cdda_core::core::components::actor::CombatStats {
        melee_skill: 0,
        melee_dice: 1,
        melee_dice_sides: 6,
        dodge: 0,
