//! Tests for `cdda_core::crafting::systems` — recipe validation,
//! component counting, ingredient consumption, and stacked-item crafting.

use bevy_ecs::prelude::*;

use cdda_components::dev::DevPlayer;
use cdda_core::core::components::def::{DefStrId, ItemName, RecipeComponentEntry};
...
use cdda_core::core::components::def::{
    RecipeComponents, RecipeQualities, RecipeResult, RecipeResultCount, RecipeTime,
};
