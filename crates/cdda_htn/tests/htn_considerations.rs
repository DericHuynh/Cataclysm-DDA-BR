//! Pins for the multi-axis utility layer (`cdda_htn::considerations`):
...
//! through [`HighestUtility`](cdda_htn::domain::SelectionPolicy) with
//! blended scores.

use cdda_htn::considerations::{blend2, blend3, curves, Consideration};
use cdda_htn::planner::{HtnPlanner, PlanStatus};
use cdda_htn::prelude::*;
