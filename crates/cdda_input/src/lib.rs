...
impl Plugin for CddaInputPlugin {
    fn build(&self, app: &mut App) {
        // Resources
        app.insert_resource(crate::InputContextStack::new());
        app.insert_resource(crate::default_bindings());
        app.init_resource::<crate::RebindCapture>();

        // Messages — InputAction is the core decoupling point
        app.add_message::<crate::InputAction>();
        ...
        app.add_systems(PreUpdate, crate::handle_raw_input);
    }
}
