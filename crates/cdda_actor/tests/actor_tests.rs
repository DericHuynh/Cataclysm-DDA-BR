...
use cdda_components::stats::{StatBonuses, Stats, STAT_DEFAULT, STAT_MAX, STAT_MIN};
...
fn proficiency_gain_from_practice() {
    ...
    let prof = t.spawn((
        ProficiencyEntry {
            id: cdda_components::ProficiencyId::from(1u32),
            known: false,
            practiced: 0,
            time_to_learn,
        },
...
fn proficiency_partial_from_long_craft() {
    ...
    let prof = t.spawn((
        ProficiencyEntry {
            id: cdda_components::ProficiencyId::from(2u32),
            known: false,
            practiced: 0,
            time_to_learn,
        },
...
fn partial_proficiency_mitigation() {
    ...
    let prof = t.spawn((
        ProficiencyEntry {
            id: cdda_components::ProficiencyId::from(3u32),
            known: false,
...
fn creature_can_have_multiple_proficiencies() {
    ...
    for id in 1u32..6 {
        let e = t.spawn((
            ProficiencyEntry {
                id: cdda_components::ProficiencyId::from(id),
                known: false,
                practiced: 0,
                time_to_learn: 10000,
            },
