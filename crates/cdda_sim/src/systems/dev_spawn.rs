...
use cdda_core::ZLevel;
use cdda_input::{GameAction, InputAction};

use crate::def_components::{DefStrId, IsDef, ItemName};
use crate::systems::dev_move::DevCamera;
use crate::systems::inventory::DevGroundItemName;
...
pub fn dev_spawn_flush(world: &mut World) {
    ...
    for def_entity in queue {
        ...
        let spawned = crate::systems::spawning::spawn_item(world, def_entity, pos, 1);
