...
/// Flags as a bitset. Systems that *filter* on flags promote them to
/// zero-sized marker components; this is for display/description.
#[derive(Component, Debug, Clone)]
pub struct ItemFlagList(pub Vec<String>);
