...
use cdda_components::actor::{BodyPartDef, BodyPartHp, BodyPartOf, BodyPartSlot, Health, IsAlive};
use cdda_sim::actor::healing::*;
...
fn healing_rate_starving() {
    ...
    assert!(starve_hp < fed_hp, "starvation should reduce healing rate");
}
