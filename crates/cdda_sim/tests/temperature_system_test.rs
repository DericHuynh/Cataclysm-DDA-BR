...
use cdda_actor::components::{BodyTemperature, Health, IsAlive, Wetness};
use cdda_core::{ItemId, Time};
use cdda_item::components::{PreservesTemp, Sealed, Spoilable};
use cdda_sim::def_components::ArmourPart;
use cdda_sim::systems::temperature::*;
