...
//!
//! Tests call the actual implementations in `cdda_sim::systems::inventory`
...
use cdda_sim::def_components::{DefStrId, ItemLongestSide, ItemVolume, ItemWeight};
...
fn small_item_fits_pocket() {
    ...
    let container = test.spawn((
        ...
        Pocket {
            ...
            pocket_type: cdda_item::components::PocketType::Container,
        },
    ));
