...
Top-level workspaces and durable boundaries (each owns its own child index):

- `crates/AGENTS.md` — Workspace crate ownership, dependency direction, and crate-level development contracts. Contains one `AGENTS.md` per workspace member.
- `data/AGENTS.md` — JSON data, mod definitions, and data-loading artifacts (`data/core/`, `data/mods/`, `data/schemas/`).
